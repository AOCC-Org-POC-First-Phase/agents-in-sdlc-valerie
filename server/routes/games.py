...
This module provides endpoints to retrieve game information.
"""
...
def get_games_base_query() -> Query:
    """
    Returns the base SQLAlchemy query for games with joined publisher and category data.
...
def get_games() -> Response:
    """
    Returns a list of all games with their publisher and category information.
...
def get_game(id: int) -> tuple[Response, int] | Response:
    """
    Returns a specific game by its ID with publisher and category information.
